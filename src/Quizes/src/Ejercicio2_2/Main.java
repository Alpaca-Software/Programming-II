...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        p.add(new Profesores ("Magister", "Maicol", "Robles salazar", "3104281078", 30, "Juan 23", "El Macho"));
        p.add(new Profesores ("Magister", "Maicol", "Robles salazar", "3104281078", 30, "Juan 23", "El Mocho"));
        p.add(new Profesores ("Magister", "Maicol", "Robles salazar", "3104281078", 30, "Juan 23", "El Malo"));
        m.mostrarDatos(p);
        ...
        e.add(new Estudiante ("Sistemas", "marcelo", "contreras", "3142987642", 50, "marabel", "Masculino"));
        e.add(new Estudiante ("comunicacion", "marcela", "contreras", "3142987642", 20, "marabel", "Femenino"));
        e.add(new Estudiante ("zootecnia", "marcos", "contreras", "3142987642", 10, "marabel", "Masculino"));
        m.mostrarDatos(e);
