...
public class Pagos {
    ...
    public void listaVentas(){
        for (int i = 0; i < clientes.size(); i++) {
            ...
            System.out.println(clientes.get(i).getNombreCliente()+" "+clientes.get(i).getCedulaCliente());
            System.out.println("Compro el siguiente articulo");
            System.out.println(objetos.get(i).getNombreProducto()+" "+objetos.get(i).getPrecioProducto());
