...
public class Administrativo extends Persona implements IPedirDatos{
    ...
    public Administrativo(String numeroDeAñosTrabajados, String nombre, String cedula, String edad, String sexo) {
    ...
    public void mostrarDatos() {
        ...
        System.out.println(this.nombre+" con CC: "+this.cedula+" sexo: "+this.sexo+" tiene los sigiuentes años de experiencia: "+this.numeroDeAñosTrabajados+" y cuenta con la edad de: "+this.edad);
    }
