...
public class Person {
    ...
    public Person(String document, String name1, String name2, String lastName1, String lastName2, int age) {
    ...
    public String toString() {
        return "Person{" + "document=" + document + ", name1=" + name1 + ", name2=" + name2 + ", lastName1=" + lastName1 + ", lastName2=" + lastName2 + ", age=" + age + '}';
    }
