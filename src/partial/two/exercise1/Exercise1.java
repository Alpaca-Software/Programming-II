 ...
 * lista a un método que calcula el salario de cada trabajador y devuelve una nueva lista con el
 * nombre y el salario calculado. Mostrar la nueva lista por consola."
 */
