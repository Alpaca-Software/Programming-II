...
public class Person {
  ...
  public static void showPersonLegalAndMinorAge(ArrayList<Person> persons) {
    ...
    System.out.println(
        "La cantidad de personas que son mayores de edad son " + Person.countPersonLegalAge);

    System.out.println(
        "La cantidad de personas que son menores de edad son " + Person.countPersonMinorAge);
  }
}
