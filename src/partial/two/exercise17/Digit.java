...
public class Digit {
  ...
  public static String digitEnglish[] = {
    "zero", "one", "two", "three", "four", "five", "six", "seven", "eight", "nine"
  };
  public static String digitSpanish[] = {
    ...
    for (int i = 0; i < sizeArray; i++) {
      if ((digits.get(i).digit >= 0 && digits.get(i).digit <= 9)) {
        ...
        if (digits.get(i).lenguage.equalsIgnoreCase("Spanish")) {
          System.out.println(
              "traducion del digito " + translate + " es " + Digit.digitSpanish[translate]);
        }
      }
    }
  }
    ...
    for (int i = 0; i < sizeArray; i++) {
      if ((digits.get(i).digit >= 0 && digits.get(i).digit <= 9)) {
        ...
        if (digits.get(i).lenguage.equalsIgnoreCase("English")) {
          System.out.println(
              "traducion del digito " + translate + " es " + Digit.digitEnglish[translate]);
        }
      }
    }
  }
