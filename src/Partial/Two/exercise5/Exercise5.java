...
/**
"5. You have a list of students with the following information: 
* the name and a series of results from the quizzes taken during 
* the semester stored in an array. It is required to know the average of the quizzes."
 */
