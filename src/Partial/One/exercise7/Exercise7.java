...
/**
 * "7. You must create a list of products with the following data: the name of
 * the product, the IVA and the base price. Now you must calculate the real sale
 * price and display the total sales for the day on the console."
 */
