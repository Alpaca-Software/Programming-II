...
public class Digit {
    ...
    int digit;
    String language;
    final static String DIGITS_SPANISH[] = {"cero", "uno", "dos", "tres", "cuatro", "cinco", "seix", "siete", "ocho", "nueve"};
    final static String DIGITS_ENGLISH[] = {"zero", "one", "two", "three", "four", "five", "six", "seven", "eight", "nine"};
